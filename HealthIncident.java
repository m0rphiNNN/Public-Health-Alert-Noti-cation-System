public class HealthIncident {
    ...
    private Position<HealthIncident> severityPosition; // Verimli silme için gerekli referans
    ...
    public Position<HealthIncident> getSeverityPosition() { return severityPosition; }
